...
load("./simulation/NPPR_simulation_results.RData")
...
pdf(file="./plot_generation/plot/Figure1.pdf",
    width=6.5, height=5)
par(mar=c(5,6,4,3)+.1)
...
dev.new(width=6, height=5, unit="cm")
pdf(file="./plot_generation/plot/FigureA.pdf",
    width=7, height=6)
par(mar=c(5,6,4,3)+.1)
...
pdf(file="./plot_generation/plot/Figure2.pdf",
    width=5, height=5)
par(mar=c(5,6,4,1)+.1)
...
#Figure D
dev.new(width=5, height=5, unit="cm")
pdf(file="./plot_generation/plot/FigureD.pdf",
    width=5, height=5)
par(mar=c(5,6,4,1)+.1)
...
#b=0
dev.new(width=5, height=5, unit="cm")
pdf(file="./plot_generation/plot/FigureE_a.pdf",
    width=6, height=6)
...
#b=-0.5
dev.new(width=5, height=5, unit="cm")
pdf(file="./plot_generation/plot/FigureE_b.pdf",
    width=6, height=6)
...
#b=0.5
dev.new(width=5, height=5, unit="cm")
pdf(file="./plot_generation/plot/FigureE_c.pdf",
    width=6, height=6)
...
#b=-0.25
dev.new(width=5, height=5, unit="cm")
pdf(file="./plot_generation/plot/FigureE_f.pdf",
    width=6, height=6)
plot(seq(0,300,by=0.1),lapply(seq(0,300,by=0.1),F_EU0),col="red",type = "l",lty=1,xlab ="Time (months)",ylab="Event probability",xlim=c(0,250),ylim=c(0,1), cex.lab=1.5)
...
#b=0.25
dev.new(width=5, height=5, unit="cm")
pdf(file="./plot_generation/plot/FigureE_g.pdf",
    width=6, height=6)
plot(seq(0,300,by=0.1),lapply(seq(0,300,by=0.1),F_EU0),col="red",type = "l",lty=1,xlab ="Time (months)",ylab="Event probability",xlim=c(0,250),ylim=c(0,1), cex.lab=1.5)
...
pdf(file="./plot_generation/plot/FigureF.pdf",
    width=14, height=7)
...
dev.new(width=14, height=7, unit="cm",noRStudioGD = TRUE)
pdf(file="./plot_generation/plot/Figure3.pdf",
    width=14, height=7)
par(mar=c(5,5,4,1)+.1,cex.lab=1.2)
...
dev.new(width=14, height=7, unit="cm",noRStudioGD = TRUE)
pdf(file="./plot_generation/plot/FigureG.pdf",
    width=14, height=7)
par(mar=c(5,5,4,1)+.1,cex.lab=1.2)
...
pdf(file="./plot_generation/plot/FigureH.pdf",
    width=10, height=10)
par(mar=c(5,5,4,1)+.1,cex.lab=1.2)
...
dev.new(width=10, height=10, unit="cm",noRStudioGD = TRUE)
pdf(file="./plot_generation/plot/FigureI.pdf",
    width=10, height=10)
par(mar=c(5,5,4,1)+.1,cex.lab=1.2)
...
dev.new(width=10, height=10, unit="cm",noRStudioGD = TRUE)
pdf(file="./plot_generation/plot/FigureJ.pdf",
    width=10, height=10)
par(mar=c(5,5,4,1)+.1,cex.lab=1.2)
...
dev.new(width=10, height=10, unit="cm",noRStudioGD = TRUE)
pdf(file="./plot_generation/plot/FigureK.pdf",
    width=10, height=10)
par(mar=c(5,5,4,1)+.1,cex.lab=1.2)
...
dev.new(width=10, height=10, unit="cm",noRStudioGD = TRUE)
pdf(file="./plot_generation/plot/FigureL.pdf",
    width=10, height=10)
par(mar=c(5,5,4,1)+.1,cex.lab=1.2)
...
dev.new(width=10, height=10, unit="cm",noRStudioGD = TRUE)
pdf(file="./plot_generation/plot/FigureM.pdf",
    width=10, height=10)
par(mar=c(5,5,4,1)+.1,cex.lab=1.2)
...
#Figure 4
dev.new(width=5, height=5, unit="cm")
pdf(file="./plot_generation/plot/Figure4.pdf",
    width=5, height=5)
...
#Figure 5a
dev.new(width=6, height=5, unit="cm")
pdf(file="./plot_generation/plot/Figure5_a.pdf",
    width=6, height=5)
par(mar=c(5,6,4,1)+.1)
...
#Figure 5b
dev.new(width=5, height=5, unit="cm")
pdf(file="./plot_generation/plot/Figure5_b.pdf",
    width=5, height=5)
par(mar=c(5,6,4,1)+.1)
...
#Figure O
dev.new(width=6, height=5, unit="cm")
pdf(file="./plot_generation/plot/FigureO.pdf",
    width=6, height=5)
par(mar=c(5,6,4,1)+.1)
...
#Figure C a)
dev.new(width=5, height=5, unit="cm")
pdf(file="./plot_generation/plot/FigureC_a.pdf",
    width=6, height=6)
...
#Figure C b)
dev.new(width=6, height=5, unit="cm")
pdf(file="./plot_generation/plot/FigureC_b.pdf",
    width=6, height=5)
par(mar=c(5,6,4,1)+.1)
...
#Figure C c)
dev.new(width=5, height=5, unit="cm")
pdf(file="./plot_generation/plot/FigureC_c.pdf",
    width=5, height=5)
par(mar=c(5,6,4,1)+.1)
...
#Figure C d)
dev.new(width=6, height=5, unit="cm")
pdf(file="./plot_generation/plot/FigureC_d.pdf",
    width=6, height=5)
par(mar=c(5,6,4,1)+.1)
...
dev.new(width=14, height=7, unit="cm",noRStudioGD = TRUE)
pdf(file="./plot_generation/plot/FigureN.pdf",
    width=14, height=7)
par(mar=c(5,5,4,1)+.1,cex.lab=1.2)
boxplot(Est_PR_NPPR_nocens_nna[[10]],Est_PR_NPPR_nocens_nna[[11]],Est_PR_NPPR_nocens_nna[[12]],
        est_cox(Est_PH_Cox_nocens_nna[[10]]),est_cox(Est_PH_Cox_nocens_nna[[11]]),est_cox(Est_PH_Cox_nocens_nna[[12]]),
...
dev.new(width=6, height=5, unit="cm")
pdf(file="./plot_generation/plot/FigureB.pdf",
    width=6, height=5)
